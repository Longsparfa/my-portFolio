...
const Projects = () => {
  return (
    <section
      ...
      id="projects"
    >
      <section className="grid grid-cols-[repeat(auto-fill,_minmax(400px,_1fr))] md:grid-cols-[repeat(auto-fill,_minmax(250px,_1fr))] xl:place-items-center gap-x-[2rem] sm:gap-x-[5rem] gap-y-[3rem] ">

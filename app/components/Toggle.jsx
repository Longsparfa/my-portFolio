...
const Toggle = () => {
  ...
  return (
    <div className="hidden md:flex justify-end ">
        ...
        {toggle && (
             <div className='flex justify-end items-end flex-col text-center bg-[#B4BDFF] p-[2rem] absolute top-[40px] right-0 mt-[1rem] min-w-[210px] rounded-[5px] shadow-[0_0_10px_rgba(0,0,0,0.2)] z-[99999]'>

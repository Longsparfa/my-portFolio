...
const Timeline = () => {
  return (
    <section
      ...
      id="about"
    >
      <h2 className="font-extrabold text-[56px] leading-[56px] w-max-content max-w-[100%] bg-white-gradient mb-[16px] p-[0] md:text-[48px] md:leading-[48px] md:mb-[12px] md:p-[0] sm:text-[32px] sm:leading-[40px] md:mb-[8px] overflow-y-hidden">
        About Me
      </h2>
